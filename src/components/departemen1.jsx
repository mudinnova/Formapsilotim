...
import { useNavigate } from 'react-router-dom'; // ✅ cukup useNavigate saja
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {departemenList.map((dept, index) => (
          ...
          >
            ...
            <button
              onClick={() => navigate(dept.path)} // ✅ pindah ke halaman masing-masing
              className="bg-blue-600 text-white hover:bg-blue-500 px-5 py-2 rounded-full shadow-md w-full"
            >
              Selengkapnya
            </button>
          </motion.div>
